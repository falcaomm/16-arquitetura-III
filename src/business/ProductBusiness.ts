...
import { CreateProductInputDTO, CreateProdutOutputDTO } from "../dtos/createProduct.dto"
import { EditProductInputDTO, EditProdutOutputDTO } from "../dtos/editProduct.dto"
...
export class ProductBusiness {
  ...
  public createProduct = async (input: CreateProductInputDTO) => {
    ...
    const output: CreateProdutOutputDTO = {
  ...
  public editProduct = async (input: EditProductInputDTO) => {
    ...
    const output: EditProdutOutputDTO = {
